...
export default function Contact() {
  ...
  if (isVenue) {
    return (
      <section id="contact" className="scroll-mt-28 bg-offwhite px-5 py-24 sm:px-8 sm:py-28">
        <div className="on-scroll mx-auto grid max-w-[96rem] grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-12">
  ...
  return (
    <section id="contact" className="scroll-mt-28 bg-offwhite px-5 py-24 sm:px-8 sm:py-28">
      <div className="on-scroll mx-auto grid max-w-[96rem] grid-cols-1 gap-10 lg:grid-cols-12 lg:items-end">
